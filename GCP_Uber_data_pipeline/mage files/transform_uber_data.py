...
def transform(df, *args, **kwargs):
    ...
    datetime_dim = datetime_dim[['datetime_id','tpep_pickup_datetime','pick_minute','pick_hour','pick_day','pick_month','pick_year','pick_weekday',
                                'tpep_dropoff_datetime', 'drop_minute','drop_hour', 'drop_day', 'drop_month', 'drop_year', 'drop_weekday']]
